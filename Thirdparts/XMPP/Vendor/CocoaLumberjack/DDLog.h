 ...
 * 
 * Step 3:
 * Replace your DLog statements with DDLog statements according to the severity of the message.
 * 
 * DLog(@"Fatal error, no dohickey found!"); -> DDLogError(@"Fatal error, no dohickey found!");
 * 
 * DDLog works exactly the same as DLog.
...
/**
 * Returns the threadID as it appears in DLog.
