 ...
 * 
 * Step 3:
 * Replace your DLog statements with XMPPLog statements according to the severity of the message.
 * 
 * DLog(@"Fatal error, no dohickey found!"); -> XMPPLogError(@"Fatal error, no dohickey found!");
 * 
 * XMPPLog has the same syntax as DLog.
 * This means you can pass it multiple variables just like DLog.
 * 
