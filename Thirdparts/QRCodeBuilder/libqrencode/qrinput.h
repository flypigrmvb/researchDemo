...
extern NSInteger QRinput_estimateBitsModeNum(NSInteger size);
extern NSInteger QRinput_estimateBitsModeAn(NSInteger size);
extern NSInteger QRinput_estimateBitsMode8(NSInteger size);
extern NSInteger QRinput_estimateBitsModeKanji(NSInteger size);
