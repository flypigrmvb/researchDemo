...
static QRinput_List *QRinput_List_newEntry(QRencodeMode mode, NSInteger size, const unsigned char *data)
{
	QRinput_List *entry;
...
NSInteger QRinput_append(QRinput *input, QRencodeMode mode, NSInteger size, const unsigned char *data)
{
	QRinput_List *entry;
 ...
 * @return result
 */
static NSInteger QRinput_checkModeNum(NSInteger size, const char *data)
{
	NSInteger i;
 ...
 */
NSInteger QRinput_estimateBitsModeNum(NSInteger size)
{
	NSInteger w;
	NSInteger bits;
 ...
 * @return result
 */
static int QRinput_checkModeAn(NSInteger size, const char *data)
{
	NSInteger i;
 ...
 * @return number of bits
 */
NSInteger QRinput_estimateBitsModeAn(NSInteger size)
{
	NSInteger w;
	NSInteger bits;
 ...
 * @return number of bits
 */
NSInteger QRinput_estimateBitsMode8(NSInteger size)
{
	return size * 8;
}
 ...
 * @return number of bits
 */
NSInteger QRinput_estimateBitsModeKanji(NSInteger size)
{
	return (size / 2) * 13;
}
 ...
 * @return result
 */
static NSInteger QRinput_checkModeKanji(NSInteger size, const unsigned char *data)
{
	NSInteger i;
	unsigned int val;
...
NSInteger QRinput_check(QRencodeMode mode, NSInteger size, const unsigned char *data)
{
	if(size <= 0) return -1;
 ...
 * @return number of bits
 */
static NSInteger QRinput_estimateBitStreamSizeOfEntry(QRinput_List *entry, int version)
{
	NSInteger bits = 0;
	int l, m;
	int num;
...
QRinput_Struct *QRinput_splitQRinputToStruct(QRinput *input)
{
	...
	prev = NULL;
	while(list != NULL) {
		nextbits = (int)QRinput_estimateBitStreamSizeOfEntry(list, input->version);
