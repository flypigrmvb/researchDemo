...
+ (id)CustomSwitchWithOrigin:(CGPoint)point {
    KLSwitch *kl = [[KLSwitch alloc] initWithFrame:CGRectMake(point.x, point.y, 42, 27)];
    [kl initializeDefaults];
    [kl setOnTintColor: kBColor];
    return kl;
}
