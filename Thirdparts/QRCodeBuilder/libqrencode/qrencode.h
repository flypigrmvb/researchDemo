 ...
 *
 */
extern NSInteger QRinput_append(QRinput *input, QRencodeMode mode, NSInteger size, const unsigned char *data);
 ...
 */
extern NSInteger QRinput_check(QRencodeMode mode, NSInteger size, const unsigned char *data);
